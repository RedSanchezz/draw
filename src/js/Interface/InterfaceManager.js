...
export default class InterfaceManager{
    ...
    defaultSetting(layoutManager){
        ...
        instrumentBtn.addEventListener("click", (e) => {
            if(instrumentsPanel.classList.contains("instruments-panel-open")){
                instrumentsPanel.classList.remove("instruments-panel-open");
            }
            else{
                instrumentsPanel.classList.add("instruments-panel-open");
            }
        });
